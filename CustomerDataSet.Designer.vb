...
Partial Public Class CustomerDataSet
    ...
    Partial Public Class CustomerDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddCustomerRow(ByVal First_Name As String, ByVal Age As Integer, ByVal Telephone_No As Integer, ByVal Street_Address As String) As CustomerRow
            Dim rowCustomerRow As CustomerRow = CType(Me.NewRow,CustomerRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, First_Name, Age, Telephone_No, Street_Address}
    ...
    Partial Public Class CustomerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customer` WHERE ((`Customer_ID` = ?) AND ((? = 1 AND `First_Name` IS"& _ 
                " NULL) OR (`First_Name` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)) AND"& _ 
                " ((? = 1 AND `Telephone_No` IS NULL) OR (`Telephone_No` = ?)) AND ((? = 1 AND `S"& _ 
                "treet_Address` IS NULL) OR (`Street_Address` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customer` (`First_Name`, `Age`, `Telephone_No`, `Street_Address`) VA"& _ 
                "LUES (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Customer` SET `First_Name` = ?, `Age` = ?, `Telephone_No` = ?, `Street_Ad"& _ 
                "dress` = ? WHERE ((`Customer_ID` = ?) AND ((? = 1 AND `First_Name` IS NULL) OR ("& _ 
                "`First_Name` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)) AND ((? = 1 AN"& _ 
                "D `Telephone_No` IS NULL) OR (`Telephone_No` = ?)) AND ((? = 1 AND `Street_Addre"& _ 
                "ss` IS NULL) OR (`Street_Address` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Customer_ID, First_Name, Age, Telephone_No, Street_Address FROM Customer"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Customer_ID, First_Name, Age, Telephone_No, Street_Address FROM Customer W"& _ 
                "HERE (First_Name = ?)"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Customer_ID As Integer, ByVal Original_First_Name As String, ByVal Original_Age As Global.System.Nullable(Of Integer), ByVal Original_Telephone_No As Global.System.Nullable(Of Integer), ByVal Original_Street_Address As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal First_Name As String, ByVal Age As Global.System.Nullable(Of Integer), ByVal Telephone_No As Global.System.Nullable(Of Integer), ByVal Street_Address As String) As Integer
            If (First_Name Is Nothing) Then
        ...
        Public Overloads Overridable Function Update(ByVal First_Name As String, ByVal Age As Global.System.Nullable(Of Integer), ByVal Telephone_No As Global.System.Nullable(Of Integer), ByVal Street_Address As String, ByVal Original_Customer_ID As Integer, ByVal Original_First_Name As String, ByVal Original_Age As Global.System.Nullable(Of Integer), ByVal Original_Telephone_No As Global.System.Nullable(Of Integer), ByVal Original_Street_Address As String) As Integer
            If (First_Name Is Nothing) Then
            ...
            If (Original_Telephone_No.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_Telephone_No.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_Street_Address,String)
            End If
